          ...
          >
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <div className="space-y-1 sm:space-y-2">
                <span className="text-[10px] sm:text-xs font-bold text-purple-600 bg-purple-50 px-2 py-0.5 rounded-md">
                  {post.category}
                </span>
                <h3 className="text-base sm:text-lg font-bold text-gray-800 group-hover:text-purple-600 transition-colors line-clamp-1">
                  {post.title}
                </h3>
                <p className="text-[10px] sm:text-xs text-gray-400 font-medium">{post.date}</p>
              </div>
              ...
              <div className="flex items-center gap-4 border-t sm:border-t-0 pt-3 sm:pt-0">
                <div className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-gray-400">
                  <span>❤️</span>
                  <span className="group-hover:text-rose-500 transition-colors">{post.likes}</span>
                </div>
                <div className="flex items-center gap-1.5 text-xs sm:text-sm font-bold text-gray-400">
                  <span>💬</span>
                  <span className="group-hover:text-blue-500 transition-colors">{post.comments}</span>
                </div>
