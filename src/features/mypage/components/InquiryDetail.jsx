...
import { ChevronLeft, Paperclip, MessageSquare, User, Clock } from 'lucide-react';

const InquiryDetail = ({ inquiry, onBack, getStatusStyle, getStatusLabel, categoryMap }) => {
          ...
          {inquiry.files && inquiry.files.length > 0 && (
            <div className="mt-8 pt-8 border-t border-gray-50">
              <h4 className="text-xs font-black text-gray-400 mb-4 flex items-center gap-2 uppercase tracking-wider">
                <Paperclip className="w-3.5 h-3.5" /> 첨부파일 ({inquiry.files.length})
              </h4>
