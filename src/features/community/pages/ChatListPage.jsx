...
const ChatListPage = () => {
  ...
  // Mock Data: Chat Rooms (sidebar)
  const chatRooms = [
    { 
      id: 1, 
      title: '한강 달빛 야시장 같이 가실 분? 🌙', 
      lastMessage: '6시에 여의나루역에서 볼까요?',
      time: '오후 2:36',
      unreadCount: 3,
    ...
    { 
      ...
      time: '오후 1:45',
      unreadCount: 0,
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Palace'
    },
    { 
      id: 3, 
      title: '전국 축제 도장깨기 모임 🚌', 
  ...
  return (
    <div className="flex h-[calc(100vh-80px)] bg-gray-50 font-['Pretendard']">
      <div className="max-w-7xl mx-auto w-full flex bg-white shadow-xl overflow-hidden md:my-6 md:rounded-[2.5rem] border border-gray-100">
        
        {/* Left Sidebar: Chat List */}
        <aside className="w-full md:w-80 lg:w-96 flex flex-col border-r border-gray-100 bg-white z-20">
        ...
        <div className="hidden md:flex flex-grow min-w-0 bg-gray-50/30">
          ...
          {/* Participants Sidebar (Inside Right Area) */}
          {showParticipants && (
            <aside className="w-64 border-l border-gray-100 flex flex-col bg-white animate-in slide-in-from-right duration-300">
              <div className="p-6 border-b border-gray-100">
