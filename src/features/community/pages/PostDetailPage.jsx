  ...
  return (
    <div className="min-h-screen bg-gray-50/30 font-['Pretendard'] pb-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <button 
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 text-gray-400 hover:text-purple-600 font-bold mb-8 transition-colors group"
        >
          ...
          <div className="p-8 md:p-12 border-b border-gray-50">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full bg-gray-100 overflow-hidden border-2 border-purple-100">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mt-12 pt-8 border-t border-gray-50">
              ...
              <div className="flex items-center gap-2">
                {currentUserId === post.authorId && (
                  <>
                    <button className="flex items-center gap-2 px-4 py-2 text-gray-400 hover:text-purple-600 font-bold text-sm transition-colors">
            ...
            <div className="flex gap-4 mb-10">
              ...
              <div className="flex-grow relative">
                <textarea 
                  ...
                  className="w-full bg-gray-50 border-none rounded-2xl p-4 text-sm min-h-[100px] focus:ring-2 focus:ring-purple-600/20 outline-none resize-none"
                />
                <button 
                  className="absolute bottom-4 right-4 bg-purple-600 text-white p-2.5 rounded-xl hover:bg-purple-700 transition-all active:scale-95 disabled:opacity-50"
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center gap-4">
                        <button className="text-[11px] font-black text-gray-400 hover:text-purple-600 transition-colors uppercase tracking-widest">Reply</button>
